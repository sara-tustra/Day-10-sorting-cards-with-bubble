...
sortButton.addEventListener('click', (e) => {
    ...
    for (let b = ordenarCartas.length - 1; b > 0; b--) {
        for (let c = 0; c < b; c++) {
            if (ordenarCartas[c].number > ordenarCartas[c + 1].number) {
                let aux = ordenarCartas[c];
                ordenarCartas[c] = ordenarCartas[c + 1];
                ordenarCartas[c + 1] = aux;
